                ...
                Get.to(() => JobDetail(), arguments: [
                  {
                    ...
                    "location": homeController.jobs[index].location.toString(),
                    "type": homeController.jobs[index].workType.toString(),
                    "deadline":
                        homeController.jobs[index].jobDeadline.toString(),
                    "jobTitle": homeController.jobs[index].jobTitle.toString(),
                    "level": homeController.jobs[index].level.toString(),
                          ...
                          children: [
                            CircleAvatar(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      "https://ahaduvacancy.com/Uploads/Images/" +
                                          homeController.jobs[index].companyLogo
                                              .toString(),
                                  ...
                                  case _menuItem.favorite:
                                    favoriteItem({
                                      ...
                                      "jobTitle": homeController
                                          .jobs[index].jobTitle
                                          .toString(),
                                      'level': homeController.jobs[index].level
                                          .toString(),
                                    });
                                    break;
                                  case _menuItem.share:
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            homeController.jobs[index].location
                                                .toString(),
                                            style: TextStyle(
                                                fontFamily: 'Poppins'),
                                          ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            homeController.jobs[index].workType
                                                .toString(),
                                            style: TextStyle(
                                                fontFamily: 'Poppins'),
                                            softWrap: true,
